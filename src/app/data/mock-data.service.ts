...
import type { InfoAttivita, CatalogoProdotti, CatalogoServizi, Team, Faq } from './types';
...
export class MockDataService {
  ...
  readonly prodotti$: Observable<CatalogoProdotti> = this.http
    .get<CatalogoProdotti>('/assets/mock/prodotti.json')
    .pipe(shareReplay(1));
