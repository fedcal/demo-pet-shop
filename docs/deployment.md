...
URL: `https://pet-shop.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `pet-shop.demo.federicocalo.dev`
...
- Output directory: `dist/pet-shop/browser`
...
URL: `https://fedcal.github.io/federico-demo-pet-shop/`
...
- `base: /federico-demo-pet-shop/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `pet-shop-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   pet-shop-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `pet-shop-docs.federicocalo.dev`
