...
hero:
  ...
  actions:
    - theme: brand
      text: Demo live
      link: https://pet-shop.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-pet-shop
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Pet Shop.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Pet Shop** in Italia.
...
Il mercato italiano delle PMI per **Pet Shop** ha caratteristiche specifiche:
...
- [GitHub repo](https://github.com/fedcal/federico-demo-pet-shop)
